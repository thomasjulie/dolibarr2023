...
$reshook = $hookmanager->executeHooks('infansCrecheAccueil');
if ($reshook == 1 && $hookmanager->resArray[0] == 'true') { 
	require_once 'custom/creche/pointage_action.php';
}
...
$reshook = $hookmanager->executeHooks('infansCrecheAccueil');
if ($reshook == 1 && $hookmanager->resArray[0] == 'true') { 
	require_once 'custom/creche/pointage_view.php';
} else {
