...
/**
 * \file    test/phpunit/CustomizeProspectCustomerFieldFunctionalTest.php
...
/**
 * Class CustomizeProspectCustomerFieldFunctionalTest
 *
 ...
 *
 * @package Testcustomizeprospectcustomerfield
 */
class CustomizeProspectCustomerFieldFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 468172; // TODO: autodetect?
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modCustomizeProspectCustomerField')->click();
		} else {
			// Disable the module
			$this->byHref('modCustomizeProspectCustomerField')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/customizeprospectcustomerfield/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('customizeprospectcustomerfield/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/customizeprospectcustomerfield/admin/about.php');
		$this->authenticate();
		return $this->assertContains('customizeprospectcustomerfield/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('customizeprospectcustomerfieldwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCustomizeProspectCustomerField_CustomizeProspectCustomerFieldTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCustomizeProspectCustomerField_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
