...
/**
 *   	\file       enfants_list.php
 *		\ingroup    creche
 *		\brief      List page for enfants
 */
...
$title = $langs->trans("Enfants");
//$help_url = "EN:Module_Enfants|FR:Module_Enfants_FR|ES:Módulo_Enfants";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && !getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/creche/enfants_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$topicmail = "SendEnfantsRef";
$modelmail = "enfants";
$objecttmp = new Enfants($db);
