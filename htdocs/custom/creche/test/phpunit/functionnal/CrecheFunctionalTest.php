...
/**
 * \file    test/phpunit/CrecheFunctionalTest.php
 * \ingroup creche
 ...
 * @package Testcreche
 */
class CrecheFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/creche/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('creche/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/creche/admin/about.php');
		$this->authenticate();
		return $this->assertContains('creche/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('crechewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCreche_CrecheTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCreche_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
