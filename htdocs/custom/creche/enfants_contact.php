...
/**
 *  \file       enfants_contact.php
 *  \ingroup    creche
 *  \brief      Tab for contacts linked to Enfants
 */
...
$title = $langs->trans("Enfants")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Enfants"), -1, $object->picto);
